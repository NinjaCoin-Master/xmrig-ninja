...
#   ifdef XMRIG_ALGO_ARGON2
	...
	m_map[Algorithm::AR2_NINJA][AV_SINGLE][Assembly::NONE]      = argon2::single_hash<Algorithm::AR2_NINJA>;
    m_map[Algorithm::AR2_NINJA][AV_SINGLE_SOFT][Assembly::NONE] = argon2::single_hash<Algorithm::AR2_NINJA>;
#   endif
